...
import util.constants.headers as headers
from util.constants.const_main import *

from server.router.path import get_filesystem_path
...
def do_get(request, response_builder):
    ...
    response_builder.set_file(source)
...
def do_patch(request, response_builder):
    pass
